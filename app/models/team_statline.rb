class TeamStatline < ApplicationRecord
	...
	def self.aggregate(should_aggregate)
		...
		group('team_code').select("team_code, 
										...
										SUM(unforfeited_games_played) AS unforfeited_games_played, 
										SUM(wins) AS wins,
										SUM(forfeit_wins) AS forfeit_wins,
										SUM(ot_wins) AS ot_wins,
										SUM(so_wins) AS so_wins,
										SUM(losses) AS losses,
										SUM(forfeit_losses) AS forfeit_losses,
										...
										ROUND(CAST(SUM(shots) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS shots_pg,
										ROUND(CAST(SUM(shots_against) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS shots_against_pg,
										...
										ROUND(CAST(SUM(first_period_shots) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS first_period_shots_pg,
										ROUND(CAST(SUM(second_period_shots) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS second_period_shots_pg,
										ROUND(CAST(SUM(third_period_shots) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS third_period_shots_pg,
										...
										ROUND(CAST(SUM(goals_for) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS goals_for_pg,
										ROUND(CAST(SUM(goals_against) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS goals_against_pg,
										...
										ROUND(CAST(SUM(ev_goals_for) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS ev_goals_for_pg,
										ROUND(CAST(SUM(ev_goals_against) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS ev_goals_against_pg,
										...
										ROUND(CAST(SUM(pp_goals_for) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS pp_goals_for_pg,
										ROUND(CAST(SUM(pp_goals_against) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS pp_goals_against_pg,
										ROUND(CAST(SUM(sh_goals_for) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS sh_goals_for_pg,
										ROUND(CAST(SUM(sh_goals_against) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS sh_goals_against_pg,
										...
										ROUND(CAST(SUM(first_period_goals) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS first_period_goals_pg,
										ROUND(CAST(SUM(second_period_goals) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS second_period_goals_pg,
										ROUND(CAST(SUM(third_period_goals) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS third_period_goals_pg,
										...
										ROUND(CAST(SUM(minors) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS minors_pg,
										SUM(majors) AS majors,
										ROUND(CAST(SUM(majors) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS majors_pg,
										SUM(double_minors) AS double_minors,
										ROUND(CAST(SUM(double_minors) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS double_minors_pg,
										SUM(fights) AS fights,
										ROUND(CAST(SUM(fights) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS fights_pg,
										SUM(misconducts) AS misconducts,
										ROUND(CAST(SUM(misconducts) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS misconducts_pg,
										SUM(game_misconducts) AS game_misconducts,
										ROUND(CAST(SUM(game_misconducts) AS DECIMAL) / SUM(unforfeited_games_played), 3) AS game_misconducts_pg,
